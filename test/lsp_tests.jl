...
@testset "LSP Integration Tests" begin
    ...
    @testset "Tool Parameter Validation" begin
        ...
        goto_def = filter(t -> t.id == :lsp_goto_definition, tools)[1]
        ...
        find_refs = filter(t -> t.id == :lsp_find_references, tools)[1]
        ...
        doc_syms = filter(t -> t.id == :lsp_document_symbols, tools)[1]
        ...
        ws_syms = filter(t -> t.id == :lsp_workspace_symbols, tools)[1]
