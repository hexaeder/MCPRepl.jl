    ...
    try
        @testset "VS Code Configuration" begin
            ...
            try
                ...
                @test config["servers"]["julia-repl"]["command"] == joinpath(pkgdir(MCPRepl), "mcp-julia-adapter")
        ...
        @testset "VS Code Settings.json Management" begin
            ...
            try
                ...
                existing_settings = Dict(
                    "julia.additionalArgs" => ["--project", "--threads=4"]
                )
                ...
                @test any(arg -> contains(arg, "--load") && contains(arg, ".julia-startup.jl"), 
